...
U 1 1 57E685B4
P 5000 4200
F 0 "C207" V 5008 4273 45  0000 L CNN
...
U 1 1 57E68621
P 4650 4200
F 0 "C206" V 4658 4273 45  0000 L CNN
...
U 1 1 57E68672
P 4300 4200
F 0 "C205" V 4308 4273 45  0000 L CNN
...
U 1 1 57E686C7
P 3950 4200
F 0 "C204" V 3958 4273 45  0000 L CNN
...
U 1 1 57E6871C
P 3600 4200
F 0 "C203" V 3608 4273 45  0000 L CNN
...
U 1 1 57E689A3
P 3600 3950
F 0 "#PWR0203" H 3600 3800 50  0001 C CNN
...
U 1 1 57E689C9
P 3600 4550
F 0 "#PWR0204" H 3600 4300 50  0001 C CNN
...
$EndComp
$Comp
L usevolt:XTAL_7A-12.000MAAJ-T X201
U 1 1 57E6956F
P 7250 2950
F 0 "X201" V 7158 3048 45  0000 L CNN
...
U 1 1 57E695FA
P 7550 2750
F 0 "C208" H 7500 2700 45  0000 C CNN
...
U 1 1 57E69648
P 7550 3050
F 0 "C209" H 7500 3100 45  0000 C CNN
...
U 1 1 57E69A8B
P 7300 3350
F 0 "#PWR0205" H 7300 3100 50  0001 C CNN
...
U 1 1 5891FBFB
P 9700 4500
F 0 "#PWR0207" H 9700 4250 50  0001 C CNN
...
U 1 1 5891FCDE
P 9750 3450
F 0 "#PWR0208" H 9750 3300 50  0001 C CNN
...
U 1 1 58C01582
P 2800 2750
F 0 "#PWR0201" H 2800 2600 50  0001 C CNN
...
AR Path="/57E682A9/58C01592" Ref="C201"  Part="1" 
F 0 "C201" V 2908 3023 45  0000 L CNN
...
U 1 1 58D0A5A6
P 3250 4200
F 0 "C202" V 3258 4273 45  0000 L CNN
...
$Comp
L usevolt:LPC1549JBD64 U202
U 1 1 59C4D0FB
P 5700 2750
F 0 "U202" H 6100 3826 45  0000 C CNN
...
Wire Wire Line
	9150 3650 9150 3950
$Comp
L usevolt:MCP2551_SOIC8 U201
U 1 1 5A102A85
P 2350 2950
F 0 "U201" H 2400 3254 45  0000 C CNN
...
U 1 1 5A533409
P 9500 3600
F 0 "R202" V 9508 3658 45  0000 L CNN
...
U 1 1 5A533486
P 9250 3550
F 0 "R201" V 9258 3608 45  0000 L CNN
...
$EndComp
$Comp
L usevolt:ARM_JTAG_SWD_HEADER_10_PINSMD J201
U 1 1 5A79DD45
P 9950 3950
F 0 "J201" H 10000 4400 45  0000 L CNN
...
Wire Wire Line
	5200 3250 4900 3250
Text HLabel 4900 3250 0    60   Output ~ 0
OUT2_1
Wire Wire Line
	5200 5050 4900 5050
Text HLabel 4900 5050 0    60   Output ~ 0
OUT2_2
Wire Wire Line
	5200 2950 4850 2950
Text HLabel 4850 2950 0    60   Output ~ 0
OUT3_1
Wire Wire Line
	5200 3050 4850 3050
...
Wire Wire Line
	5200 2650 4850 2650
Text HLabel 4850 2650 0    60   Output ~ 0
OUT4_1
Wire Wire Line
	5200 2750 4850 2750
Text HLabel 4850 2750 0    60   Output ~ 0
OUT4_2
Wire Wire Line
	5200 2250 4850 2250
...
Wire Wire Line
	5200 2550 4850 2550
Text HLabel 4850 2550 0    60   Output ~ 0
OUT5_2
Wire Wire Line
	7000 5650 7350 5650
...
Wire Wire Line
	7000 5750 7350 5750
Text HLabel 7350 5750 2    60   Output ~ 0
OUT6_2
Wire Wire Line
	7000 5450 7350 5450
Text HLabel 7350 5450 2    60   Output ~ 0
OUT7_1
Wire Wire Line
	7000 5550 7350 5550
Text HLabel 7350 5550 2    60   Output ~ 0
OUT7_2
Wire Wire Line
	7000 4950 7350 4950
...
Wire Wire Line
	7000 2550 7300 2550
Text HLabel 7300 2550 2    60   Output ~ 0
OUT10_1
Wire Wire Line
	7000 2150 7300 2150
...
Wire Wire Line
	5200 5550 4900 5550
Text HLabel 4900 5550 0    60   Input ~ 0
OUT1_SENSE
Wire Wire Line
	5200 5150 4900 5150
...
Wire Wire Line
	7000 1950 7300 1950
Text HLabel 7300 1950 2    60   Output ~ 0
OUT11
Wire Wire Line
	7000 2050 7300 2050
Text HLabel 7300 2050 2    60   Input ~ 0
OUT11_SENSE
$EndSCHEMATC
