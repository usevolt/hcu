...
#define CONFIG_CANOPEN_TXPDO3_ID					(CANOPEN_TXPDO2_ID + HCU_NODE_ID)
...
#define CONFIG_CANOPEN_TXPDO3_MAPPING1_MAIN_INDEX	HCU_LEFT_FOOT_CURRENT_INDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING1_SUB_INDEX	HCU_LEFT_FOOT_CURRENT_SUBINDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING1_LEN			CANOPEN_TYPE_LEN(HCU_LEFT_FOOT_CURRENT_TYPE)
#define CONFIG_CANOPEN_TXPDO3_MAPPING2_MAIN_INDEX	HCU_RIGHT_FOOT_CURRENT_INDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING2_SUB_INDEX	HCU_RIGHT_FOOT_CURRENT_SUBINDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING2_LEN			CANOPEN_TYPE_LEN(HCU_RIGHT_FOOT_CURRENT_TYPE)
#define CONFIG_CANOPEN_TXPDO3_MAPPING3_MAIN_INDEX	HCU_ROTATOR_CURRENT_INDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING3_SUB_INDEX	HCU_ROTATOR_CURRENT_SUBINDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING3_LEN			CANOPEN_TYPE_LEN(HCU_ROTATOR_CURRENT_TYPE)
